...
class ConfirmPasswordPage2 extends StatelessWidget {
  const ConfirmPasswordPage2({Key? key}) : super(key: key);
        ...
        child: SingleChildScrollView(
          child: Column(
            children: [
              ...
              SizedBox(height: 20,),
              Text("Tugadi",style: TextStyle(fontSize: 24,fontWeight: FontWeight.w700,color: Colors.black),),
              SizedBox(height: 20,),
              Padding(
